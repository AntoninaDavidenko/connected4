...
from pydantic import BaseModel, Field, NonNegativeInt, ValidationError, computed_field
...
def get_model_safe(model: type[BaseModel], model_data: dict[str, Any]) -> BaseModel | None:
    try:
